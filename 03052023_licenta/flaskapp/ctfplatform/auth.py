        ...
        try:
            ...
            if account_chkbyEmail:
                ...
                if group and group != "None":
                    ...
                    append_new_line(
                        "logs.txt", "User {} is being added to group {}--{} !".format(username, group_id, group)
                    )
                    if group_id != 0 and user_id != 0:
                        ...
                        conn.commit()
                    append_new_line(
                        "logs.txt", "User {} successfully added to group {} !".format(username, group)
                    )
                else:
                    append_new_line(
                        "logs.txt", "No group seleted!"
                    )
