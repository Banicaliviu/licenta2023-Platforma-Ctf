...
def index():
    try:
        ...
        append_new_line("logs.txt", "Error while connecting to PostgreSQL.Error occurred: {}".format(e))
    finally:
...
def register():
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form and 'email' in request.form:
        ...
        try:
            ...
            append_new_line("logs.txt", "Error occurred: {}".format(e)) 
    ...
    try:
        ...
        #print("Error while closing PostgreSQL connection", e)
        append_new_line("logs.txt", "Error while closing PostgreSQL connection.{}".format(e))
