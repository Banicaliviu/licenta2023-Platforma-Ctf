...
def run():
    ...
    app = Application([(r"/", MainHandler, dict(flag=conf["flag"]))], debug=args.debug)
...
if __name__ == "__main__":
    p = ArgumentParser(add_help=True, description="Emergency Override Server.")
    p.add_argument(
        "command",
        choices=["run", "compute"],
        help="starts the server or compute a new result using a " "random key.",
    )
