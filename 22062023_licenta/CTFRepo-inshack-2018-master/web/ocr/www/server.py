...
app.config.update(
    ...
    RECAPTCHA_SECRET_KEY=open(
        "private/config-9a9f05ed-e0d2-46f9-a761-89573214d6ff"
    ).readline(),
            ...
            try:
                ...
                if any(
                    ...
                    return render_template(
                        "result.html", result="Some features are still in beta !"
                    )
                if (
                    ...
                    return render_template(
                        "result.html",
                        result="We can not solve complex equations for now !",
                    )
                if any(
                    i in formated_text
                    for i in [
                    ...
                    return render_template(
                        "result.html", result="We can not understand your equation !"
                    )
                ...
                if "==" in formated_text:
                    ...
                    if pa_1 == pa_2:
                        ...
                        return render_template(
                            "result.html",
                            result="Sorry but it seems that %d is not equal to %d"
                            % (pa_1, pa_2),
                        )
                else:
                    return render_template(
                        "result.html", result="Please import a valid equation !"
                    )
